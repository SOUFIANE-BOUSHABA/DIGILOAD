...
import "leaflet/dist/leaflet.css"; // Import Leaflet CSS from CDN
...
const AfricaCountriesMap = () => {
    ...
    useEffect(() => {
      const map = L.map("map", {
        ...
        maxBounds: [[-35.0, -18.0], [37.0, 51.3]], 
        maxBoundsViscosity: 1.0,
      }).setView([1.5, 17.2], 3); 
  
 
  
      const geojsonLayer = L.geoJSON(africaCountries, {
        style: {
          fillColor: "#088",
          fillOpacity: 0.5,
          color: "#000",
  ...
  export default AfricaCountriesMap;